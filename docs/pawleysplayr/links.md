...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      <strong>Simple guide save the settings from an SLS/iM2 unit:</strong><br>
      Quick field procedure for logging into SensorLab (SLS/iM2), accessing the active program, and exporting the settings file to a USB drive for backup or transfer.<br>
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/SLS+-+Save+Settings+File+to+USB+Memory+Stick.pdf">
        SLS - Save Settings File to USB Memory Stick.pdf
      </a>
    </div>
  </li>
  ...
  <li>
    <div>
      ...
      This guide develooped by I.Toro outlines a simple method to determine the operating system version (Windows 7 vs. Windows 10) on SensorLab (SLS) <br>
  ...
  <li>
    ...
    <li>
    <div>
      <strong>Simple field guide to Enable Windows to automatically restart after BSOD:</strong><br>
      Step-by-step guide for enabling automatic system restart after a Blue Screen (BSOD) on SensorLab Steel / iM2 systems, including access to Windows system settings and recommended configuration for crash.<br>
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/Enable+Windows+to+automatically+restart+after+BSOD.pdf">
        Enable Windows to automatically restart after BSOD.pdf
      </a>
    </div>
  </li>
...
<li>
  <div>
    <strong>SLS ProfiNet Output Register Direct Overlay (TIA Portal v18) – Rev1 Quick Setup Guide:</strong><br>
    ...
    Covers importing the UDT_HEN_SLS2PLC_Overlay source file, generating the PLC data type from source, locating and recording the input <br>
    start address in Device configuration → Device overview, creating an EAF_SLS PLC tag table, adding Station 1 / Station 2 tags at the correct <br>
    %I addresses, then compiling, downloading, going online, and monitoring live data from the expanded UDT tags.<br>
    <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/SLS+ProfiNet+Output+Register+Direct+Overlay_Rev1.pdf">
      SLS ProfiNet Output Register Direct Overlay_Rev1.pdf
    </a>
    <br>
    <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/FC_UDTs/UDT_HEN_SLS2PLC_Overlay.zip">
      UDT_HEN_SLS2PLC_Overlay.zip
    </a>
	    <br>
    <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/FC_UDTs/UDT_HEN_PLC2SLS_Overlay.zip">
      UDT_HEN_PLC2SLS_Overlay.zip
    </a>
  </div>
</li>
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/Set+up+SLS+for+EIP+Output+Registers.pdf">
  ...
  <li>
  <div>
    <strong>Set up SLS for EIP Input Registers :</strong><br>
    Step-by-step setup to enable EtherNet/IP Input Registers on SensorLab Steel / IM2: covers network prerequisites, <br>
    login, LAN configuration, editing the active program, enabling EtherNet/IP communication, selecting Use Registers, <br>
    Low byte first, Single precision Float, and saving/activating the new program<br>
    <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/Set+up+SLS+for+EIP+Input+Registers.pdf">
      Set up SLS for EIP Input Registers.pdf
    </a>
  </div>
</li>
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/sls/help_docs/Set+up+PLC+for+EIP+Generic+Ethernet+Module+Communication+to+SLS.pdf">
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      <strong>HEN_SLSWriter_PLC2SLS_AOI_v1.0:</strong><br>
...
<li>
  ...
  <li>
    <div>
	  ...
	  Includes the purpose of the new High Byte and Low Byte variants, the rationale for the PLC-aligned layout, a comparison to default Table 26 offsets, and the equivalent <br>
	  offset table for the new telegram definitions.<br>
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/hyd/GM_Hydris_PLC_Aligned_Output_Telegrams_Reference+-+04022026.pdf">
        GM_Hydris_PLC_Aligned_Output_Telegrams_Reference - 04022026.pdf
      </a>
    </div>
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
 ...
 <li>
    <div>
      <strong>CasTemp, CasTemp Wireless and CasTemp Superheat manual v2.1:</strong><br>
      Castemp CTW Windows Manual<br>
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/ctw/CasTemp%2C+CasTemp+Wireless+and+CasTemp+Superheat+manual+2.1_EN_original+(1).pdf">
        CasTemp, CasTemp Wireless and CasTemp Superheat manual 2.1_EN_original.pdf
      </a>
 ...
 <li>
  ...
  <li>
    <div>
      <strong>CTWReadAssembler_CLX20 — ControlLogix/CompactLogix AOI (ZIP):</strong><br>
      Studio 5000 v20+ Add-On Instruction that parses CasTemp Wireless (CTW) EtherNet/IP input (128-byte assembly) into a structured UDT <br>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/ctw/CTWReadAssembler_CLX20_AOI.zip">
        CTWReadAssembler_CLX20_AOI.zip
      </a>
    </div>
  </li>
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      <strong>CasTemp Wireless E5 manual 1.1_EN:</strong><br>
      CasTemp Wireless E5 Manual v1.1.<br>  
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/ctw5/CasTemp+Wireless+E5+manual+1.1_EN.pdf">
        CasTemp Wireless E5 manual 1.1_EN.pdf
      </a>
    </div>
  </li>
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/ctw5/CTW-E5_EIP_Commissioning_Rev2_2026-06-01.pdf">
        CTW-E5_EIP_Commissioning_Rev2_2026-06-01.pdf
      </a>
    </div>
  </li>
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/ctw5/AOIs/HEN_CTWE5Parser_CLX20_AOI.zip">
...
<ul style="list-style-type: disc; margin-left: 2em; font-size: 1.05em;">
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/eds/M30/005A0000002E0100.zip">
  ...
  <li>
    <div>
      ...
      <a href="https://pawleyslogic-downloads.s3.us-east-2.amazonaws.com/eds/M40/005A002B00370100.zip">
